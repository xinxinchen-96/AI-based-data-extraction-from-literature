...
dict <- dplyr::select(dict, c(Sheet, name))
...
process_treatment_matrix <- function(ls) {
  ...
  name_map_dfs <- map(mngt_dfs, function(df) {
    ...
    df_out <- dplyr::select(df, all_of(c(level_col, name_col)))
  ...
  treatments <- dplyr::select(treatments, -all_of(treatment_lev_nms))
...
todrop <- c( "institute_ID", "people_level", "document_ID", "revision_notes", 
            ...
            "local_season_name","row_direction","plants_per_hill","panting_material_weight","planting_material_age", "transplant_age","nursery_env_pl_material","length_sprout_material","seedbed_density", "germination","fertile_tiller_num","planting_material_source",
            ...
            "NO3_applied_fertilizer","NH4_applied_fertilizer","Urea_applied_fertilizer", "fertilizer_applic_method",
            ...
            "fertilizer_level_name","fert_#_tot","fert_applics_tot","fertilizer_season","fertilizer_notes","field_notes",
            "field_geocoord_original","field_location_source","field_loc_anon","field_landscape_position","field_plow_layer_depth",
            "field_plow_layer_compac","drain_radius","soil_file","weather_file",
            ...
            "field_slope","field_slope_length","field_slope_aspect","obstruction_to_sun","field_length_width_ratio","drainage_type","depth_to_drain","drain_spacing",
            "field_surface_stones","field_soil_depth","water_table_depth","wsta_distance","field_history","field_history_duration"
...
sections_to_remove <- c("GENOTYPES", "TREATMENTS","EXP_METADATA",
                        #"FIELDS",
                        "SOIL_METADATA","WEATHER_METADATA","INITIAL_CONDITIONS",
                        "IRRIGATIONS","TILLAGE","SOIL_PROFILES","SOIL_ANALYSES",
                        "CHEMICALS","ENVIRON_MODIFICATIONS",  "HARVESTS","PLOT_DETAILS", "PLANTINGS",
                        "FERTILIZERS"
                        )
...
lapply(names(str_data_json), function(name) {
  writeLines(str_data_json[[name]], con = file.path("C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_fields_v050526_v125", paste0(name, ".json")))})
...
icasa_dict <- icasa_dict %>%
  ...
  dplyr::select(section, variable_name, description, json_type, unit_or_type)
      ...
      final_structure <- list(
        messages = list(
          list(role = "system",
           ...
           list(role = "user",
          content = paste("Understanding and extract the ICASA experiment_ID, field_name, field_id,field_country,field_sub_country,field_sub_sub_country, field_latitude, field_longitude, field_elevation, field_soil_texture et al variables from this content:", user_content)),
...
generate_training_file(
  ...
  str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_fields_v050526_v125",  # json folder
  output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1_only_method_fields_v050526_v125.jsonl",  # training data name
  # tool_definition = tool_definition,  # the ICASA dict
  method = "one_to_one" 
)

# generate_training_file(
#   md_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set/0_tokenized_pdfs_tables_and_methods_combined_titleauthor",  # markown folder
...
# generate_training_file(
#   md_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/0_tokenized_pdfs_tables_and_methods_combined_titleauthor_addyear",
#   str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_fields_v070426",  # json folder
#   output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1N_only_method_fields_v070426.jsonl",  # training data name
#   #tool_definition = tool_definition,  # the ICASA dict
#   method = "one_to_many" 
# )
