...
todrop <- c( "institute_ID", "people_level", "document_ID", "revision_notes", 
            ...
            "site_name","exper_duration_seasons","anonymization","experiment_narrative",
            "fertilizer_level_name","fert_#_tot","fert_applics_tot","fertilizer_season","fertilizer_notes",
            #"name_of_experiment","experiment_type","management_type",
            "objective_of_study","experiment_narrative",
           "transplant_date" ,"planting_material_weight", "planting_method"
...
sections_to_remove <- c("GENOTYPES", "TREATMENTS",
                        ...
                        "SOIL_PROFILES",
                        "SOIL_ANALYSES",
                        "CHEMICALS","ENVIRON_MODIFICATIONS",  "HARVESTS","PLOT_DETAILS")
...
lapply(names(str_data_json), function(name) {
  writeLines(str_data_json[[name]], con = file.path("C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_exp_metadata_json_v050526_v125", paste0(name, ".json")))})
      ...
      final_structure <- list(
        messages = list(
          list(role = "system",
           ...
           list(role = "user",
                content = paste("Extract the ICASA experiment_ID,name_of_experiment,experiment_type,management_type,number_of_replicates,number_of_treatments,experimental_design,main_experiment_factor,experimental_factor_comb,experiment_duration variables from this content:", user_content)),
...
generate_training_file(
  ...
  str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_exp_metadata_json_v050526_v125",  # json folder
  output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1_only_method_exp_metadata_v050526_v125.jsonl",  # training data name  # tool_definition = tool_definition,  # the ICASA dict
  method = "one_to_one" 
)
...
#   str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_planting_v310326",  # json folder
#   output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1N_only_method_planting_v310326.jsonl",  # training data name
#   #tool_definition = tool_definition,  # the ICASA dict
#   method = "one_to_many" 
# )
