...
template_path <-"C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/0_template/template_icasa_vba_trainingSet_allColumns_v125.xlsm"
...
#"experiment_ID",
todrop <- c( "institute_ID", "people_level", "document_ID", "revision_notes", 
            ...
            "harvest_operations_level", "exp_code_local","experiment_name_local"  ,"site_type",
            "experiment_year", "cropping_system", "rotation_system",
            "rotation", "constraints", "complications", "ex_funding_source", "method_notes","ex_license","distrib_restrictions" , "anomymization", "file_version","revision_notes" ,
            "field_id", "soil_identifier", "weather_sta_identifier", "field_geocoord_original", "field_location_source",
            "field_loc_anon","field_landscape_position","field_slope", "field_slope_length", "field_slope_aspect","field_area","obstruction_to_sun","field_length_width_ratio" ,
            "field_plow_layer_depth", "field_plow_layer_compac","drainage_type", "depth_to_drain","drain_to_drain","drain_spacing","drain_radius",
            "field_history", "field_history_duration","field_surface_stones", "field_soil_texture", "field_soil_depth", "water_table_depth","soil_file","weather_file",
            "plot_row_number", "plot_separation","plot_orientation","drainage_orientation", "plots_relative_to_drains","plot_harvest_length", "plot_harvest_width","plots_harvest_date", "plot_harvest_row_number","harvest_method_plot",
            "cultivar_identifier","cultivar_name_orig","cultivar_synonym","cultivar_class", "cultivar_release_year","breeding_program", "accession_id","accession_location","pedigree","cultivar_reference", "relative_maturity","cultivar_seed_weight",
            "local_season_name","row_direction","plants_per_hill","planting_material_weight","planting_material_age", "transplant_age","nursery_env_pl_material","length_sprout_material","seedbed_density", "germination","fertile_tiller_num","planting_material_source",
            
            "soil_profile_slope", "soil_profile_methods", "file_version_sl", "soil_citation","soil_notes",
            
           "harvest_operations_level", "harvest_operat_component","harvest_stage","harv_operat_main_product",
           "harv_operation_byproduct","harv_operat_size_categor","harvested_crop","harvest_area","harvest_amount",
           "harvest_cut_height", "harvest_notes",
           "harvest_comments",
           
            
            "digital_object_identifier_wst", "document_name_wst", "e_mail_address", "institute_name", "institute_role","institute_type","researcher_address","researcher_first_name","researcher_last_name",
            "researcher_name_mi","researcher_role","document_link_wst","weather_station_name", "weather_station_site", "wsta_location_country", "wsta_loc_2nd_level","wsta_loc_3rd_level","weather_sta_latitude",
            "weather_sta_longitude","weather_sta_elevation","source_daily_weather","temperature_sensor_ht","ref_height_windsp_meas",
            "ref_height_weather_meas","climate_scenario_category", "climate_scenario_id","durat_summarization_per", "growing_season_duration","growing_season_start_day",
            "angstrom_coef_a_month","angstrom_coef_a_year","angstrom_coef_b_month","angstrom_coef_b_year","psychrometric_constant.","psychrometer_ventilation","rainfall_parm_alpha","flag_for_summary_data",
           
            "soil_denitrification_fac", "cona","soil_fertility_on_photo","diffus_const","summer_u",
            "winter_u", "diffus_slope", "layer_drainage_rate_per_day","van_genuch_alpha", "van_genuch_n",
            "cation_exchange_capacity", "soil_adsorption_coef",  "soil_water_uptake_factor","soil_compac_fact_by_lyr",
            "NH4soil_kCl","nitrate_KCl","phosphorus_extractable","phosphorus_total","phosphorus_organic", "phosphorus_isotherm_A","phosphorus_iostherm_B","potassium_exchangeable",
            "CaCO3_content","soil_calcium_conc" , "soil_aluminum_conc", "soil_iron_conc","soil_magnesium_conc", "soil_manganese_conc",
            "soil_sodium_conc","soil_sulfur_conc","soil_base_saturation","electric_conductivity","plant_root_uptake_factor",
            "B_in_applied_fertilizer","Ca_in_applied_fertilizer","Fe_in_applied_fertilizer","Mg_in_applied_fertilizer","Mn_in_applied_fertilizer","S_in_applied_fertilizer",
            "Zn_in_applied_fertilizer","other_elements_appl_fert", "fertiliz_code_other_elem",
            "soil_color_moist_Munsell","soil_active_C","soil_active_C_fraction","soil_inert_C","soil_inert_C_fraction","soil_intermediate_C","soil_intermediate_C_fraction","soil_stable_C","soil_stable_C_fraction",
            

            "application_depth_chem", "chemical_applic_amount", "chemical_applic_target","chemical_applic_notes",
            
            "document_name_sl","e_mail_address","institute_name","institute_role","institude_type","researcher_first_name", "researcher_last_name", "researcher_name_mi","researcher_role"          ,
            
            "transplant_date","planting_material_weight","planting_method", "soil_profile_methods","file_version_sl", "soil_citation","soil_license","revision_notes_sl","soil_notes",
            
            "name_of_soil_profile","soil_sampling_date","soil_profile_slope","soil_source",
            
            #"name_of_experiment","experiment_type","management_type","objective_of_study","experiment_narrative",
            
            
            #, treatment_number, treatment_name, field_name, planting_level_name, initial_conditions_name,irrigation_level_name, fertilizer_level_name,tillage_treatment_name, soil_analysis_name, chemical_applic_name, environ_modif_name, harvest_ops_level_name
            
            "master_horizon","root_growth_factor_soil","soil_water_air_dry","soil_color_moist_Munsell",
            "soil_active_C","soil_active_C_fraction","soil_inert_C","soil_inert_C_fraction","soil_intermediate_C",
            "soil_intermediate_C_fraction","soil_stable_C","soil_stable_C_fraction","soil_water_residual",
            "soil_water_wilting_pt","soil_water_field_cap_1","soil_water_field_cap_2","layer_drainage_rate_per_day",
            "van_genuch_alpha","van_genuch_n","soil_water_uptake_factor","soil_compac_fact_by_lyr",
            "NH4soil_kCl","nitrate_KCl","phosphorus_extractable","phosphorus_total","phosphorus_organic",
            "phosphorus_isotherm_A","phosphorus_iostherm_B","potassium_exchangeable","CaCO3_content",
            "soil_calcium_conc","soil_aluminum_conc","soil_iron_conc","soil_magnesium_conc",
            "soil_manganese_conc","soil_sodium_conc","soil_sulfur_conc","soil_base_saturation",
            "electric_conductivity","plant_root_uptake_factor","soil_N_total_conc","soil_organic_matter_layer",
            "soil_classific_system","soil_classification", "soil_drainage_class","soil_albedo",
            "soil_albedo_moist","soil_evaporation_limit","drainage_rate_per_day","runoff_curve_no_SCS",
            "soil_surface_color", "surface_stones_(cover)","mineralization_factor","pH_buffer_determin_meth",
            "potassium_determ_method","phosphorus_determ_method","depth_of_topsoil","soil_texture","soil_pH_in_buffer",
            
            "experiment_narrative","site_name","exper_duration_seasons","experiment_year","cropping_system","rotation","constraints",
            "complications","ex_funding_source","method_notes","ex_license","distrib_restrictions","anonymization","file_version","revision_notes"
            
            )  # <--- NB: add here any column you wish to exclude from training set
...
names(data_merged_names_noid[["EXP_METADATA"]])


intersect(todrop, names(data_merged_names_noid[["EXP_METADATA"]]))
...
remove_todrop_cols <- function(ls, todrop) {
  lapply(ls, function(df) df[, !(names(df) %in% todrop), drop = FALSE])
}

data_final <- lapply(data_merged_names_noid, remove_todrop_cols, todrop = todrop)
data_final <- lapply(data_final, function(ls) {
  lapply(ls, function(df) distinct(df))  #
})

# ---- Remove entire sections (GENOTYPES, TREATMENTS) ----
sections_to_remove <- c("GENOTYPES", "TREATMENTS",
                        "EXP_METADATA",
                        "FIELDS",
                        "SOIL_METADATA",
                        "WEATHER_METADATA","INITIAL_CONDITIONS",
                        "IRRIGATIONS",
                        "PLANTINGS","FERTILIZERS","TILLAGE",
                        "SOIL_PROFILES",
                        "SOIL_ANALYSES",
                        "CHEMICALS","ENVIRON_MODIFICATIONS",  #"HARVESTS",
                        "PLOT_DETAILS")

data_final <- lapply(data_final, function(ls) {
  ls[!(names(ls) %in% sections_to_remove)]  # drop unwanted sections
})
#########################################################

str_data_json <- lapply(data_final, generate_json)


# Write files
lapply(names(str_data_json), function(name) {
  writeLines(str_data_json[[name]], con = file.path("C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_harvest_json_v050526_v125", paste0(name, ".json")))
})
...
icasa_dict <- icasa_dict %>%
  filter(Subset %in% c(  # <-- Add/remove ICASA sections you want to include/exclude in the training job
   ...
   "WEATHER_METADATA", "WEATHER_STATION",
    ...
    #,"EXP_METADATA","FIELDS","PLOT_DETAILS","GENOTYPES","TREATMENTS"
    # ,"SOIL_METADATA","WEATHER_METADATA","INITIAL_CONDITIONS"
    # ,"IRRIGATIONS","FERTILIZERS","TILLAGE","SOIL_PROFILES","SOIL_ANALYSES","CHEMICALS"
    # ,"ENVIRON_MODIFICATIONS","HARVESTS"
    )) %>%
...
# Remove todrop variables from the dictionary BEFORE generating the schema
icasa_dict_filtered <- icasa_dict %>%
  filter(!variable_name %in% todrop)

# Generate schema from filtered dictionary
icasa_schema <- generate_icasa_schema(icasa_dict_filtered)

# Now assemble the tool definition
tool_definition <- list(
  ...
  `function` = list(
    ...
    description = paste(
      ...
      "The ICASA data model (provided in parameters) provides a list of standard variable names in several sections, with their respective unit and data type.",
      ...
      "All extracted terms must be valid terms from the ICASA controlled vocabulary. For numeric properties (e.g., yields) units must be extracted and converted to the target unit, provided in the unit_or_type property.",
      "If a specific variable is not mentioned in the text for a given experiment, return null for this variable."
    ),
    parameters = icasa_schema
  )
)
  ...
  for (md_path in md_files) {
    ...
    create_jsonl_entry <- function(user_content, tool_arguments_string) {
      final_structure <- list(
        messages = list(
          list(role = "system",
               content = paste("You are expert in agriculture")),
          
           list(role = "user",
          content = paste("Extract the ICASA experiment_ID,harvest_ops_level_name,harvest_operations_date,harvest_method,harvest_operations_notes variables from this content:", user_content)),
...
generate_training_file(
  md_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/0_tokenized_pdfs_tables_and_methods_combined_titleauthor_addyear",  # markown folder
  str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_harvest_json_v050526_v125",  # json folder
  output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1_only_method_harvest_v050526_v125.jsonl",  # training data name
...
# generate_training_file(
#   md_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set/0_tokenized_pdfs_onlymethod",  # markown folder
#   str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set/1_template_json",  # json folder
#   output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set/text2icasa_training_data_1to1_only_method.jsonl",  # training data name
#   tool_definition = tool_definition,  # the ICASA dict
#   method = "one_to_one" 
# )
...
# generate_training_file(
#   md_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/0_tokenized_pdfs_tables_and_methods_combined_titleauthor_addyear",  # markown folder
#   str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_harvest_json_v140426",  # json folder
#   output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1N_only_method_harvest_v140426.jsonl",  # training data name
#   #tool_definition = tool_definition,  # the ICASA dict
#   method = "one_to_many" 
# )
# 
