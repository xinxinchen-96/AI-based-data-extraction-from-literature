...
todrop <- c( "institute_ID", "people_level", "document_ID", "revision_notes", 
            ...
            "cultivar_name_orig","cultivar_synonym","cultivar_class","cultivar_release_year",
            "breeding_program","accession_id","accession_location","pedigree","cultivar_reference",
            "relative_maturity","cultivar_seed_weight"
...
sections_to_remove <- c(#"GENOTYPES", 
  "TREATMENTS","EXP_METADATA","FIELDS",
...
lapply(names(str_data_json), function(name) {
  writeLines(str_data_json[[name]], con = file.path("C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_genotypes_v050526_v125", paste0(name, ".json")))})
      ...
      final_structure <- list(
        messages = list(
          list(role = "system",
           ...
           list(role = "user",
          content = paste("Understanding and extract the experiment_ID, ICASA cultivar_name,crop_ident_ICASA,crop_intended_use,cultivar_notes et al variables from this content:", user_content)),
...
generate_training_file(
  ...
  str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_genotypes_v050526_v125",  # json folder
  output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1_only_method_genotypes_v050526_v125.jsonl",  # training data name
...
#   str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_genotypes_v310326",  # json folder
#   output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1N_only_method_genotypes_v310326.jsonl",  # training data name
#   #tool_definition = tool_definition,  # the ICASA dict
#   method = "one_to_many" 
# )
# 
