...
sections_to_remove <- c("GENOTYPES", "TREATMENTS","EXP_METADATA","FIELDS",
...
lapply(names(str_data_json), function(name) {
  writeLines(str_data_json[[name]], con = file.path("C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_planting_v050526_v125", paste0(name, ".json")))})
      ...
      final_structure <- list(
        messages = list(
          list(role = "system",
           ...
           list(role = "user",
          content = paste("Understanding and extract the ICASA planting_level_name, planting_date, emergence_date, plant_pop_at_planting, plant_pop_at_emergence, planting_material, planting_distribution, plant_spacing, row_spacing, planting_depth,planting_notes et al variables from this content:", user_content)),
...
generate_training_file(
  ...
  str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_planting_v050526_v125",  # json folder
  output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1_only_method_planting_v050526_v125.jsonl",  # training data name
