...
todrop <- c( "institute_ID", "people_level", "document_ID", "revision_notes", 
            ...
            "plot_orientation","plot_harvest_length","plot_harvest_width","plot_harvest_area","harvest_method_plot",
            
            "plot_row_number","plots_relative_to_drains","plot_harvest_row_number","drainage_orientation"
...
lapply(names(str_data_json), function(name) {
    writeLines(str_data_json[[name]], con = file.path("C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_plotdetails_v050526_v125", paste0(name, ".json")))})
      ...
      final_structure <- list(
        messages = list(
          list(role = "system",
           ...
           list(role = "user",
          content = paste("Understanding and extract the ICASA plot_length, plot_width, plot_area, plot_separation, plot_layout et al variables from this content:", user_content)),
...
generate_training_file(
  ...
  str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_plotdetails_v050526_v125",  # json folder
  output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1_only_method_plotdetils_v050526_v125.jsonl",  # training data name
...
#   str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_json_plotdetails_v31032026",  # json folder
#   output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1N_only_method_plotdetails_v31032026.jsonl",  # training data name
#   #tool_definition = tool_definition,  # the ICASA dict
#   method = "one_to_many" 
# )
