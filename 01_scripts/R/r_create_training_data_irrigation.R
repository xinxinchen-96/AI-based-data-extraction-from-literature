...
todrop <- c( "institute_ID", "people_level", "document_ID", "revision_notes", 
            ...
            "irrigation_level_name", "irrigation_operation","irrigation_applic_depth",      "irrigation_H2O_N_conc",
            "bund_height","irrigation_notes",
            ...
            "irrigation_level_name","irrig_applied", "irrigation_applics_season", "irrigation_season",
            "irrigation_notes", "irrigation_H2O_N_conc", "bund_height",
...
sections_to_remove <- c("GENOTYPES", "TREATMENTS","EXP_METADATA","FIELDS",
                        ...
                        #"IRRIGATIONS",
                        "PLANTINGS","FERTILIZERS","TILLAGE","SOIL_PROFILES","SOIL_ANALYSES",
...
lapply(names(str_data_json), function(name) {
  writeLines(str_data_json[[name]], con = file.path("C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_irrigation_json_v050526_v125", paste0(name, ".json")))
})
      ...
      final_structure <- list(
        messages = list(
          list(role = "system",
           ...
           list(role = "user",
          content = paste("Extract the ICASA experiment_ID, irrigation_operation_name, irrigation_date, irrigation_operation, irrig_amount_depth, irrigation_operation_notes variables from this content:", user_content)),
...
generate_training_file(
  ...
  str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_irrigation_json_v050526_v125",  # json folder
  output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1_only_method_irrigation_v050526_v125.jsonl",  # training data name
...
# generate_training_file(
#   md_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/0_tokenized_pdfs_tables_and_methods_combined_titleauthor_addyear",  # markown folder
#   str_folder = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/1_template_irrigation_json_v090426",  # json folder
#   output_file = "C:/Users/xinxin/OneDrive - Leibniz-Zentrum für Agrarlandschaftsforschung (ZALF) e.V/Desktop/FAIRagro_fine_tunning/data/0_training_set_version2/text2icasa_training_data_1to1N_only_method_irrigation_v090426.jsonl",  # training data name
#   #tool_definition = tool_definition,  # the ICASA dict
#   method = "one_to_many" 
# )
# 
